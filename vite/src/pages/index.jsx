      ...
      <div className="first-container">
        <div className="first-texts">
          ...
          <p className="project-description">
            Welcome to iLearnX Beyond Web3, where you can learn from the basic
            of internet to how-to-Web3 development. We curated free learning
      ...
      <div className="forth-container">
        ...
        <div className="mini-boxes">
          ...
          <div className="minibox1">
            <p className="minibox1-text">
              Q. Can I just learn normal programming?
            </p>
            <p className="minibox1-text">
              A. Absolutely! What you learn is all your choice!
            </p>
          </div>
          {/* Minibox 2 */}
          <div className="minibox2">
            <p className="minibox2-text">
              {" "}
              Q. I am a beginner. A.Start from <a href="/track">Here!</a>
            </p>
          </div>
          {/* Minibox 3 */}
          <div className="minibox3">
            ...
            <p className="minibox3-text">
              A.Ain’t no easy money!! if there is it's mostly scam, but you can
              join <a href="/icp">ICP hackathon</a> or{" "}
              <a href="https://ilearnx.vercel.app/">our hackathon course</a> to
              learn&earn!
            </p>
          </div>
          {/* Minibox 4 */}
          ...
          <div className="minibox5">
            ...
            <p className="minibox5-text">
              A. Use our up-coming marketplace to list your progress and sell by
              hour/task!
            </p>
          </div>
          {/* Minibox 6 */}
          ...
          <div className="minibox7">
            Check <a href="/track">Web3 Roadmap</a>
            <p className="minibox7-text"></p>
          </div>
          {/* Minibox 8 */}
          <div className="minibox8">
            Hackathon of this season
            <p className="minibox8-text">
              <a href="/icp">ICP</a>
            </p>
          </div>
          {/* Minibox 9 */}
          <div className="minibox9">
            ...
            <p className="minibox9-text">
              Form a team on discord or{" "}
              <a href="https://ilearnx.vercel.app/">sign-up!</a>(Beginner
              friendly)
            </p>
          </div>
        </div>
